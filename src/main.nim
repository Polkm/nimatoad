...
addDraw(model("models/station_alpha.ply", shdr, trans.addr, "bmps/notbadd.bmp"))
...
var panel = screen3d(xPos: 0, yPos : 0, zPos : 0, pitch : 80, yaw : 60, roll : 0)

proc drwFunc() =
  panel.yaw = panel.yaw + 1.0
  a()
  b()
  c()
